    ...
    <>
        <nav className='w-full md:h-[60px] static bg-[#131921] flex flex-col md:flex-row items-center md:space-x-2 space-y-2 p-1 md:px-4'>
            <div className='hidden md:flex flex-2 justify-between order-1 space-x-2'>
                <div>
                    <img src="/logo.png" alt="" className='w-[50px] md:w-[100px]' />
                </div>

                <div className='flex items-center'>
                    <IoLocationOutline className='text-sm md:text-xl'/>
                    <div className='flex flex-col'>
                        <p className='text-[10px] md:text-sm'>Hello</p>
                        <strong className='text-[10px] md:text-sm'>Select your address</strong>
                    </div>
                </div>
            </div>
            ...
            <div className='w-full flex flex-1 order-2'>
                ...
                <div className='hidden category__list absolute top-8 md:top-14 bg-white'>
            ...
            <div className='hidden md:flex flex-2 justify-between order-3'>
                <div>
                    ...
                    <div className='hidden lang__list absolute top-8 md:top-14 bg-white p-2'>
                ...
                <div className='flex items-center space-x-2 md:space-x-6'>
                    <div className='flex flex-col'>
                        <p className='text-[10px] md:text-xs'>Hello, Sign in</p>
                        <strong className='text-[10px] md:text-sm'>Account & Lists</strong>
                    </div>
                    <div className='flex flex-col'>
                        <p className='text-[10px] md:text-xs'>Returns</p>
                        <strong className='text-[10px] md:text-sm'>& Orders</strong>
                    </div>
                    <div className='flex items-center'>
                    <BsCart3 className='text-lg md:text-3xl'/>
